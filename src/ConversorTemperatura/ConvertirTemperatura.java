...
public class ConvertirTemperatura {
	...
	public double ConvertirCelciusAFarenheit(double valor) {
		...
		JOptionPane.showConfirmDialog(null, +valor+ " Grados Celcius son " +farenheit+ " Grados Farenheit");
			return farenheit;
	}
	...
	public void ConvertirFarenheitACelcius(double valor){
        ...
        JOptionPane.showMessageDialog(null, +valor+ " Grados Celcius son " +celcius+ " Kelvin");
	}
	...
	public double ConvertirKelvinACelcius(double valor){
        ...
        JOptionPane.showMessageDialog(null, +valor+ " Grados Celcius son " +kelvinCelcius+ " Kelvin");
